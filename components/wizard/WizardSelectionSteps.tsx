...
export const StepApproach: React.FC<StepProps> = ({ onNavigate }) => (
  <div className="animate-fade-in text-center max-w-5xl mx-auto">
    ...
    <div className="grid md:grid-cols-3 gap-4 md:gap-6 mt-8 md:mt-12">
      <button type="button" onClick={() => onNavigate('step2-safe-bonds', 50)} className={`${cardStyle} border-blue-100 hover:border-blue-500 shadow-lg shadow-blue-100/40 hover:shadow-xl hover:shadow-blue-200/50`}>
      ...
      <button type="button" onClick={() => onNavigate('step2-growth-type', 40)} className={`${cardStyle} border-emerald-100 hover:border-emerald-500 shadow-lg shadow-emerald-100/40 hover:shadow-xl hover:shadow-emerald-200/50`}>
      ...
      {/* NOWY KAFELEK DLA RODZICÓW */}
      <button type="button" onClick={() => onNavigate('redirect-parents', 0)} className={`${cardStyle} border-purple-100 hover:border-purple-500 shadow-lg shadow-purple-100/40 hover:shadow-xl hover:shadow-purple-200/50`}>
          <i className="fas fa-user-shield absolute -bottom-5 -right-5 text-8xl md:text-9xl text-purple-50 opacity-50 transition-transform duration-500 pointer-events-none"></i>
        <div className="relative z-10">
          <h3 className="font-bold text-xl md:text-2xl text-primary mb-2 md:mb-3">Spokojna Emerytura</h3>
          <p className="text-gray-500 text-sm leading-relaxed">Chcę zadbać o swoją przyszłość (IKE/IKZE), aby nie być ciężarem dla dzieci.</p>
        </div>
      </button>
    </div>
  </div>
...
export const StepSafeCheck: React.FC<StepProps> = ({ onNavigate }) => (
  <div className="animate-fade-in text-center max-w-xl mx-auto">
    ...
    <div className="grid grid-cols-2 gap-4 md:gap-6 mt-8 md:mt-12">
      <button type="button" onClick={() => onNavigate('result-family-bonds', 100)} className={`${cardStyle} border-gray-100 hover:border-pink-300 shadow-lg shadow-gray-100/40 hover:shadow-xl hover:shadow-pink-100/50 text-center flex flex-col items-center justify-center min-h-[160px]`}>
        <i className="fas fa-baby-carriage text-3xl md:text-4xl text-pink-400 mb-4 md:mb-6 pointer-events-none"></i>
        <span className="font-bold text-lg md:text-xl text-primary">Tak</span>
      </button>
      <button type="button" onClick={() => onNavigate('result-standard-bonds', 100)} className={`${cardStyle} border-gray-100 hover:border-blue-300 shadow-lg shadow-gray-100/40 hover:shadow-xl hover:shadow-blue-100/50 text-center flex flex-col items-center justify-center min-h-[160px]`}>
        <i className="fas fa-times text-3xl md:text-4xl text-gray-300 mb-4 md:mb-6 pointer-events-none"></i>
...
export const StepGrowthType: React.FC<StepProps> = ({ onNavigate }) => (
  <div className="animate-fade-in text-center max-w-3xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 gap-4 md:gap-8 mt-8 md:mt-12">
      <button type="button" onClick={() => onNavigate('step2-growth-market', 60)} className={`${cardStyle} border-emerald-100 hover:border-emerald-500 shadow-lg shadow-emerald-100/40 hover:shadow-xl hover:shadow-emerald-200/50`}>
          <i className="fas fa-globe absolute -bottom-5 -right-5 text-8xl md:text-9xl text-emerald-50 opacity-50 transition-transform duration-500 pointer-events-none"></i>
        <div className="relative z-10">
      ...
      <button type="button" onClick={() => onNavigate('result-metals', 100)} className={`${cardStyle} border-amber-100 hover:border-amber-500 shadow-lg shadow-amber-100/40 hover:shadow-xl hover:shadow-amber-200/50`}>
          <i className="fas fa-gem absolute -bottom-5 -right-5 text-8xl md:text-9xl text-amber-50 opacity-50 transition-transform duration-500 pointer-events-none"></i>
        <div className="relative z-10">
...
export const StepGrowthMarket: React.FC<StepProps> = ({ onNavigate }) => (
  <div className="animate-fade-in text-center max-w-3xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 gap-4 md:gap-8 mt-8 md:mt-12 text-left">
      <button type="button" onClick={() => onNavigate('step3-risk', 75)} className={`${cardStyle} border-emerald-100 hover:border-emerald-500 shadow-lg shadow-emerald-100/40 hover:shadow-xl hover:shadow-emerald-200/50`}>
        <i className="fas fa-hourglass-half absolute -bottom-5 -right-5 text-8xl md:text-9xl text-emerald-50 opacity-50 transition-transform duration-500 pointer-events-none"></i>
        <div className="relative z-10">
      ...
      <button type="button" onClick={() => onNavigate('result-active', 100)} className={`${cardStyle} border-orange-100 hover:border-orange-500 shadow-lg shadow-orange-100/40 hover:shadow-xl hover:shadow-orange-200/50`}>
          <i className="fas fa-search-dollar absolute -bottom-5 -right-5 text-8xl md:text-9xl text-orange-50 opacity-50 transition-transform duration-500 pointer-events-none"></i>
        <div className="relative z-10">
...
export const StepRisk: React.FC<StepProps> = ({ onNavigate }) => (
  <div className="animate-fade-in text-center max-w-xl mx-auto">
    ...
    <div className="space-y-4">
      <button type="button" onClick={() => onNavigate('result-mix', 100)} className={`${cardStyle} border-red-100 hover:border-red-500 shadow-lg shadow-red-100/40 hover:shadow-xl hover:shadow-red-200/50`}>
        <i className="fas fa-face-angry absolute -bottom-5 -right-5 text-8xl md:text-9xl text-red-50 opacity-50 transition-transform duration-500 pointer-events-none"></i>
        <div className="relative z-10">
      ...
      <button type="button" onClick={() => onNavigate('result-etf', 100)} className={`${cardStyle} border-emerald-100 hover:border-emerald-500 shadow-lg shadow-emerald-100/40 hover:shadow-xl hover:shadow-emerald-200/50`}>
        <i className="fas fa-chart-line absolute -bottom-5 -right-5 text-8xl md:text-9xl text-emerald-50 opacity-50 transition-transform duration-500 pointer-events-none"></i>
        <div className="relative z-10">
