...
const StepBadge: React.FC<StepBadgeProps> = ({ step, label, colorClass = "bg-accent" }) => (
  <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30">
    <div className={`${colorClass} border-2 border-white shadow-xl rounded-2xl px-8 py-3 flex flex-col items-center justify-center min-w-[200px]`}>
