...
const LegalModal: React.FC<LegalModalProps> = ({ isOpen, type, onClose, onResetCookies }) => {
  ...
  const handleResetCookies = () => {
    if (confirm('Czy na pewno chcesz zresetować ustawienia plików cookies?')) {
      ...
      content = (
        <div className="space-y-6 text-sm text-gray-600 leading-relaxed">
          <section>
            ...
            <p>Niniejszy regulamin określa zasady korzystania z serwisu edukacyjnego Rodzice Inwestują. Właścicielem serwisu jest podmiot prywatny, a kontakt możliwy jest pod adresem: {SUPPORT_EMAIL}.</p>
          </section>
          <section>
      ...
      content = (
        <div className="space-y-8 text-sm text-gray-600 leading-relaxed">
          ...
          <section>
            ...
            >
              <i aria-hidden="true" className="fas fa-cookie-bite"></i> Zresetuj ustawienia cookies dla tej strony
            </button>
          </section>

          <section>
            <h4 className="font-bold text-primary text-base mb-2">5. Kontakt</h4>
            <p>W przypadku pytań dotyczących przetwarzania danych, prosimy o kontakt pod adresem: {SUPPORT_EMAIL}.</p>
          </section>
        </div>
      );
      break;
        ...
        <div className="text-center py-4">
          ...
          <div className="bg-white border border-gray-100 shadow-xl rounded-3xl p-6 mb-8 max-w-sm mx-auto relative overflow-hidden">
            ...
            <div className="w-16 h-16 bg-blue-50 text-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
              <i aria-hidden="true" className="fas fa-at text-2xl"></i>
            </div>
            ...
            >
              Napisz teraz <i aria-hidden="true" className="fas fa-paper-plane ml-2"></i>
            </a>
          </div>
