                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-20 xl:gap-24">
                    <div className="lg:w-3/5 text-center lg:text-left">
                        <h1 className="font-display font-bold text-4xl sm:text-5xl lg:text-7xl leading-[1.1] mb-6 tracking-tight">
                            Podaruj dziecku {' '}
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-emerald-300">łatwiejszy start</span>
                            <br /> w dorosłość.
                        </h1>
                        <p className="text-base sm:text-lg text-blue-50 mb-10 leading-relaxed max-w-3xl mx-auto lg:mx-0 font-medium opacity-90">
                            Nie musisz być bogaty, by zbudować dziecku kapitał. Dowiedz się, jak zamienić <span className="text-accent font-bold">małe kwoty</span> (nawet z 800+) na duże rezultaty, pokonując <span className="tooltip-term text-accent font-bold border-accent/40 hover:border-accent" data-tip="Wzrost cen towarów i usług.">inflację</span>.
                        </p>
                        
                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 w-full">
                            <button onClick={() => navigateTo('wizard')} className="w-full sm:w-auto bg-accent hover:bg-green-500 text-white font-display font-bold py-4 px-8 rounded-full shadow-lg shadow-accent/20 hover:shadow-xl hover:shadow-accent/30 transition-all duration-300 ease-out text-lg active:scale-95">
                                Wybierz swoją drogę
                            </button>
                            
                            <button onClick={() => scrollToId('problem')} className="group w-full sm:w-auto flex items-center justify-center gap-2 bg-white/5 hover:bg-white border border-white text-white hover:text-primary font-display font-bold py-4 px-8 rounded-full transition-all duration-300 backdrop-blur-sm text-lg active:scale-95">
                                Sprawdź kroki <i className="fas fa-arrow-down text-sm group-hover:translate-y-1 transition-transform opacity-70"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="lg:w-2/5 flex justify-center lg:justify-end mb-4 lg:mb-0">
                        <div className="relative w-72 h-72 sm:w-80 sm:h-80 bg-white/10 rounded-full flex items-center justify-center backdrop-blur-sm border border-white/10 shadow-2xl shadow-primary/30">
                            <i className="fas fa-rocket text-8xl sm:text-9xl text-accent drop-shadow-2xl transform hover:scale-110 transition-transform duration-500"></i>
                            ...
                            <div className="absolute bottom-6 -left-8 bg-white text-primary p-4 rounded-2xl shadow-xl flex items-center gap-3 animate-pulse-subtle border border-gray-100" style={{ animationDelay: '1.5s' }}>
